<div>
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            ...
            @if($product->status == 1)
                <span class="ml-2 px-2 py-0.5 bg-slate-100 text-success btn btn-success text-xs rounded-m">Active</span>
            @else
                <span class="ml-2 p-5 py-0.5 mb-5 bg-slate-100 text-danger btn btn-danger text-xs rounded-m">Inactive</span>
            @endif
        </h2>
    </div>
