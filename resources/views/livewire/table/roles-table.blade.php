...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a class="btn btn-primary shadow-md mr-2" href="{{ Route('role.create') }}">
            Add New Roles
        </a>
        <div class="dropdown">
            ...
            <tr class="intro-x">
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        ...
                        <form method="POST" action="{{ Route('role.destroy', $role) }}" onsubmit="return confirm('Are you sure?')" >
                            @csrf
                            @method('DELETE')
                            <button class="flex items-center text-danger" type="submit"> <i class="fa-regular fa-trash-can w-4 h-4 mr-1" ></i> Delete</button>
                        </form>
                    </div>
                </td>
            </tr>
